...
<div class="grid-container">
  ...
  <div style="display:flex; justify-content:space-between;">
    <a class="btn2" style="color: #86cccc;" href="ResumeForm.html"><button class="btnprimary butn">Back</button></a><br>
		<a class="btn1" style="color: #86cccc;" href="#"><button class="btnprimary butn"	onclick="f();">Print</button></a>
</div>
    <div class="headTitle">
    
      <h1><?php echo ucwords($first_name);?><br><?php echo ucwords($last_name);?></h1>
    </div>
    <div class="subTitle">
